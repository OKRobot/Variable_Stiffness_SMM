...
plot_range_direct = find(~isnan(y1Vec_direct) == 1);
plot(equals_line,equals_line,'Color','g');
plot(y0Vec3(plot_range_direct), y1Vec_direct(plot_range_direct),'LineWidth',2,'Color','k');
...
legend('y=x','Adaptive k ','Adaptive k model','Fixed k');
